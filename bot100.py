...
def main():
 ...
 Asisten pribadi 
 Hanya untuk  pribadi
 Bukan untuk umum / sale
 ——————————————————————
 [1] Taplove 100
 ——————————————————————
 
 """)
 menu = input("Silahkan typing angka 1 : ")
 if menu == 'x':
  cekakunmu()
 if menu == 'y':
  cekid()
...
def bomlisterner():
 ...
 Up Room Bot.
 Tutorial :
 1. Masukan link live Room
 2. Jumlah bot yang dimasukan jangan lebih dari 100
 3. waktu jeda bot masuk
 *Nb :
 jumlah bot 100.
 ''')
...
def bomtaplop():
 sleep(1)
 print('''
 Gunakan Fitur ini dengan baik jangan disalah gunakan.
 ''')
 inputlink = input("Masukan Link LIVE : ")
 respone = requests.get(inputlink)
 url = respone.url
